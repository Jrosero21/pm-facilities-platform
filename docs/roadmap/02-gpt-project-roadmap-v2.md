...
•    Retired by v2 phases: FB-10a.3 / FB-10l.2 / FB-10l.3 (Phase 18) · FB-10a.4 (Phase 20) · B-16.3 (Phase 21) · the live email send backend — the "Send is a manual status flip / no live send provider" gap (17a / §6), never a numbered CF item, NOT a CF-12.x item (Phase 19) · B-16.4 (Phase 27 data dependency) · B-16.5 (Phase 26 per agent) · the operator-portal-UI bank items B-14.1/14.3/14.4/B-15.3/CF-14.3 (Phases 18/22/28 as the surfaces land).
