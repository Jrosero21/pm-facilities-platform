...
•    Photo/attachment physical storage backend (object storage; the metadata placeholder gets real bytes). Retires CF-13.4.
...
•    Retired by v2 phases: FB-10a.3 / FB-10l.2 / FB-10l.3 (Phase 18) · CF-13.4 (Phase 20) · B-16.3 (Phase 21) · CF-12.x outbound send (Phase 19) · B-16.4 (Phase 27 data dependency) · B-16.5 (Phase 26 per agent) · the operator-portal-UI bank items B-14.1/14.3/14.4/B-15.3/CF-14.3 (Phases 18/22/28 as the surfaces land).
•    Still banked beyond v2 (or revisited within it): CF-12.1 (credential encryption-at-rest — a production-hardening item, not autonomy-blocking) · CF-13.1/13.2/13.3/13.5 (email autonomy + live receiver/parser — a separate going-live track) · B-14.2 / B-15.2 (PM/snow live triggers — the live-trigger track) · CF-16.1 (source_type intent-tag) · CF-16.2 (invoice aging) · CF-16.3 (source_id polymorphic-meaning doc) · CF-14.2 (authz wrapper on approve fns) · FB-10b.1 (tenants.type enum hygiene) · FB-10p.1 (seed rename) · CF-12.4 (harness orphan-sweep hygiene).
