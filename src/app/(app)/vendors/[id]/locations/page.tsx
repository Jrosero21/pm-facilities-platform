  ...
  return (
    <div>
      ...
      <div className="mt-1 flex items-center justify-between">
        <h1 className="text-2xl font-semibold tracking-tight">{vendor.name} — Locations</h1>
        <Link
      ...
      {locations.length === 0 ? (
        <p className="mt-8 text-sm text-neutral-600">No locations yet for this vendor.</p>
      ) : (
